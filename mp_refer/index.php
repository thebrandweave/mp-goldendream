    ...
    try {
        ...
        if (empty($errors)) {
            ...
            if ($registrationType === 'customer') {
                ...
                // Send WhatsApp welcome message to customer
                $welcomeMessage = "Welcome to Golden Dream! Dear $name, you have successfully registered as a customer. Your ID is: $uniqueID. You can now login to your account and start your journey with us. Thank you for choosing Golden Dream!";

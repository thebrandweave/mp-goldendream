...
.circle:nth-child(1) { stroke:rgb(33, 117, 94); animation-delay: 0s; }
.circle:nth-child(2) { stroke: #2F9B7F; animation-delay: 0.4s; }
.circle:nth-child(3) { stroke:rgb(71, 153, 131); animation-delay: 0.8s; }
.circle:nth-child(4) { stroke:rgb(87, 188, 161); animation-delay: 1.2s; }
